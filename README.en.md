# IDM Activation Script — Simplified Chinese Edition (v1.3.9)
...
| Modes | `[2]` activate (recommended), `[1]` freeze trial (fallback), `[3]` reset activation/trial |
...
1. Download the latest ZIP from
   ...
   [`release/IDM-Activation-Script-v1.3.9.zip`](https://github.com/tytsxai/IDM-Activation-Script-Chinese/raw/main/release/IDM-Activation-Script-v1.3.9.zip)
   ([SHA256](https://github.com/tytsxai/IDM-Activation-Script-Chinese/raw/main/release/IDM-Activation-Script-v1.3.9.zip.sha256)).
2. Optional but recommended — verify the download in PowerShell:

   ```powershell
   Get-FileHash .\IDM-Activation-Script-v1.3.9.zip -Algorithm SHA256
   ```
...
`/silent` without one of `/frz` `/act` `/res` exits with code `2`.
...
Full FAQ (14 entries, in Chinese): [README.md#-常见问题](README.md#-常见问题).
...
| `IAS.cmd` | Core engine (GBK batch), also accepts `/frz` `/act` `/res` `/silent` `/log=` |
